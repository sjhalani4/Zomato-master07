...
const MobileNav=()=>{
    ...
    const MediumNav = () => {
        return(<>
        <div className="hidden gap-4 justify-between items-center gap-1 w-full  md:flex lg:w-3/4">
        <div className="w-28  ">
                <img src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.png" alt="Zomato"
                className="w-full h-full"/>
            </div>
        ...
        <input type="text" placeholder="Alwar" className="w-full focus:outline-none"/>
            <IoMdArrowDropdown/>
                </div>
